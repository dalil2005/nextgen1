    ...
    if ($client) {
        if (password_verify($password, $client['Password'])) {
            ...
            if (isset($_SERVER['HTTP_REFERER'])) {
                ...
                if (strpos($referer, '../user/confirmation.php') !== false || strpos($referer, '/user/confirmation.php') !== false) {
                    // Redirect to thank you page
                    header('Location: ../user/thank_you.php');
                    exit(); // Stop script execution after redirect
                } 
                // Check if coming from user index.php
                else if (strpos($referer, '../user/index.php') !== false || strpos($referer, '/user/index.php') !== false) {
                    // Redirect back to user index.php
